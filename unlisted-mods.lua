...
function update()
    ...
    if menuTable[3][2].status == 0 and ((c.cutscene == CUTSCENE_STAR_SPAWN) or (c.cutscene == CUTSCENE_RED_COIN_STAR_SPAWN)) then
    ...
    --Romhack Cam
    if menuTable[3][1].status == 1 and BaseGame then
        romhack_camera(m)
