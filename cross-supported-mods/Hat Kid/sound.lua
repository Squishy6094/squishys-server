...
local function use_custom_voice(m)
    return gPlayerSyncTable[m.playerIndex].modelId == E_MODEL_HAT_KID --Put your condition here!
end
...
local CUSTOM_VOICETABLE = {
    [CHAR_SOUND_ATTACKED] = '0A.mp3',
    [CHAR_SOUND_COUGHING1] = '1D.mp3',
    [CHAR_SOUND_COUGHING2] = '1D.mp3',
    [CHAR_SOUND_COUGHING3] = '1D.mp3',
    [CHAR_SOUND_DOH] = '10.mp3',
    [CHAR_SOUND_DROWNING] = '2F.mp3',
    [CHAR_SOUND_DYING] = '2A.mp3',
    [CHAR_SOUND_EEUH] = '09.mp3',
    --[CHAR_SOUND_GAME_OVER] = 'Game_Over.ogg',
    [CHAR_SOUND_GROUND_POUND_WAH] = '07.mp3',
    [CHAR_SOUND_HAHA] = '03.mp3',
    [CHAR_SOUND_HAHA_2] = '03.mp3',
    --[CHAR_SOUND_HELLO] = '12.mp3',
    [CHAR_SOUND_HERE_WE_GO] = '0C.mp3',
    [CHAR_SOUND_HOOHOO] = '1B.mp3',
    [CHAR_SOUND_HRMM] = '06.mp3',
    [CHAR_SOUND_IMA_TIRED] = '17.mp3',
    [CHAR_SOUND_LETS_A_GO] = '1A.mp3',
    [CHAR_SOUND_MAMA_MIA] = '2D.mp3',
    [CHAR_SOUND_OKEY_DOKEY] = '2E.mp3',
    [CHAR_SOUND_ON_FIRE] = '1C.mp3',
    [CHAR_SOUND_OOOF] = '0B.mp3',
    [CHAR_SOUND_OOOF2] = '0B.mp3',
    [CHAR_SOUND_PANTING] = '2B.mp3',
    [CHAR_SOUND_PANTING_COLD] = '20.mp3',
    --[CHAR_SOUND_PRESS_START_TO_PLAY] = 'Press_Start_to_Play.ogg',
    [CHAR_SOUND_PUNCH_HOO] = '11.mp3',
    [CHAR_SOUND_PUNCH_WAH] = '01.mp3',
    [CHAR_SOUND_PUNCH_YAH] = '02.mp3',
    [CHAR_SOUND_SNORING1] = '0E.mp3',
    [CHAR_SOUND_SNORING2] = '0F.mp3',
    [CHAR_SOUND_SNORING3] = {'0E.mp3', '0F.mp3', '15.mp3'},
    [CHAR_SOUND_SO_LONGA_BOWSER] = '16.mp3',
    [CHAR_SOUND_TWIRL_BOUNCE] = '14.mp3',
    [CHAR_SOUND_UH] = '05.mp3',
    [CHAR_SOUND_UH2] = '13.mp3',
    [CHAR_SOUND_UH2_2] = '05.mp3',
    [CHAR_SOUND_WAAAOOOW] = '2C.mp3',
    [CHAR_SOUND_WAH2] = '07.mp3',
    [CHAR_SOUND_WHOA] = '08.mp3',
    [CHAR_SOUND_YAHOO] = '04.mp3',
    [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = {'04.mp3', '18.mp3', '19.mp3'},
    [CHAR_SOUND_YAH_WAH_HOO] = {'02.mp3', '01.mp3', '00.mp3'},
    [CHAR_SOUND_YAWNING] = '0D.mp3',
}
