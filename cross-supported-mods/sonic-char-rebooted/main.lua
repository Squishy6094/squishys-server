...
function spawn_spindust(m)
    ...
    if e.spawnDelay > 1 then
        ...
        m.pos.z,
        function(o)
            o.oMoveAngleYaw = m.faceAngle.y + math.random(-0x1000, 0x1000)
...
hook_mario_action(ACT_BOUND_POUND, act_bound_pound, INT_GROUND_POUND_OR_TWIRL)

if not _G.ssExists then
    hook_chat_command("sonic", "[\\#00C7FF\\on\\#ffffff\\|\\#A02200\\off\\#ffffff\\] turn \\#4084d9\\Sonic \\#00C7FF\\on \\#ffffff\\or \\#A02200\\off", sonic_command)
end
